...
<section class="page-section portfolio" id="<?= $page->slug() ?>">
	<div class="container">
		...
		<div class="row">
			<?php foreach($page->modals()->toStructure() as $modal): ?>
				<div class="col-md-6 col-lg-4 mb-5">
					<div class="portfolio-item mx-auto" data-toggle="modal" data-target="#<?= $modal->title()->slug() ?>">
						<div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
							<div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
						</div>
						<?php if($image = $modal->image()->toFile()): ?>
							<img class="img-fluid" src="<?= $image->url() ?>" alt="" />
						<?php endif ?>
					</div>
				</div>
				
				<div class="portfolio-modal modal fade" id="<?= $modal->title()->slug() ?>" tabindex="-1" role="dialog" aria-labelledby="portfolioModal1Label" aria-hidden="true">
								...
								<div class="container">
									<div class="row justify-content-center">
										<div class="col-lg-8">
											...
											<h2 class="portfolio-modal-title text-secondary text-uppercase mb-0" id="portfolioModal1Label"><?= $modal->title() ?></h2>
											<!-- Icon Divider-->
											<div class="divider-custom">
												<div class="divider-custom-line"></div>
												<div class="divider-custom-icon"><i class="fas fa-star"></i></div>
											...
											<p class="mb-5"><?= $modal->textarea()->kt() ?>.</p>
